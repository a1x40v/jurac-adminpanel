...
{
    public static class UserChoisesProfile
    {
        public const string BakOfoUp = "Бакалавриат ОФО Уголовно-правовой профиль";
        public const string BakZfoUp = "Бакалавриат ЗФО Уголовно-правовой профиль";
        public const string BakOzfoUp = "Бакалавриат ОЗФО Уголовно-правовой профиль";
        public const string BakOfoGp = "Бакалавриат ОФО Гражданско-правовой профиль";
        ...
        /*  depricated profiles */
        public const string AspOfoTip = "Аспирантура ОФО Теория и история права и государства, история учений о праве и государстве";
        public const string AspZfoTip = "Аспирантура ЗФО Теория и история права и государства, история учений о праве и государстве";
        public const string AspOfoUp = "Аспирантура ОФО Уголовный процесс";
        public const string AspZfoUp = "Аспирантура ЗФО Уголовный процесс";
        public const string AspOfoKs = "Аспирантура ОФО Криминалистика; судебно-экспертная деятельность; оперативно-розыскная деятельность";
        public const string AspZfoKs = "Аспирантура ЗФО Криминалистика; судебно-экспертная деятельность; оперативно-розыскная деятельность";
    }
}