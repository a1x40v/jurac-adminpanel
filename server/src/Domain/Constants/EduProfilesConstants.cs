...
namespace Domain.Constants
{
    public static class EduProfilesConstants
    {
        public static readonly Dictionary<EduProfileType, string> Titles = new Dictionary<EduProfileType, string> {
            ...
            {EduProfileType.SpecZfoSd, "Специалитет ЗФО Судебная деятельность"},
            ...
            {EduProfileType.MagOfoCorp, "Магистратура ОФО Юрист в сфере корпоративного права"},
            {EduProfileType.MagZfoCorp, "Магистратура ЗФО Юрист в сфере корпоративного права"},
            {EduProfileType.MagOfoMed, "Магистратура ОФО Медицинское право (юрист в сфере здравоохранения)"},
            {EduProfileType.MagZfoMed, "Магистратура ЗФО Медицинское право (юрист в сфере здравоохранения)"},
