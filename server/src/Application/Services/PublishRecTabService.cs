...
namespace Application.Services
{
    public class PublishRecTabService : IPublishRecTabService
    {
        ...
        private static Dictionary<EduProfileType, Func<PublishRecTabDto, bool>> Selectors = new Dictionary<EduProfileType, Func<PublishRecTabDto, bool>>
        {
            ...
            {EduProfileType.SpecZfoSd, (recTab) => recTab.SpecZfoSd},
            ...
            {EduProfileType.MagOfoCorp, (recTab) => recTab.MagOfoCorp},
            {EduProfileType.MagZfoCorp, (recTab) => recTab.MagZfoCorp},
            {EduProfileType.MagOfoMed, (recTab) => recTab.MagOfoMed},
            {EduProfileType.MagZfoMed, (recTab) => recTab.MagZfoMed},
